...
gbm2 <- read.csv('axa-gbm5-10k-depth=2-train=.75-shrink=.001-seed=2222.csv.gz')
gbm3 <- read.csv('axa-gbm5-10k-depth=3-train=.75-shrink=.001-seed=3333.csv.gz')
...
file <- paste0("axa-gbm2-5-merge", ".csv.gz")
